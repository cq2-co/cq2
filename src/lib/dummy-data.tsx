const DemoData = {
  ...
  threads: [
    ...
    },
    {
      ...
      comments: [
        ...
        },
        {
          ...
          timestamp: 1708621048292,
          highlights: [],
          whole_to_thread_id: 3,
        },
      ],
    },
    {
    ...
    },
    {
      thread_id: 6,
      parent_thread_id: 5,
      quote: "assist us in certain aspects",
      quote_by: "Caleb",
      comments: [
        {
          comment_id: 1,
          ...
          timestamp: 1708621581036,
          highlights: [],
          whole_to_thread_id: 7,
        },
      ],
    },
    {
    ...
    },
    {
      thread_id: 8,
      parent_thread_id: 5,
      quote: "not a substitute for our creative thinking",
      quote_by: "Caleb",
      comments: [
        {
          comment_id: 1,
          ...
          timestamp: 1708621810771,
          highlights: [],
          whole_to_thread_id: 9,
        },
      ],
    },
    {
      ...
      comments: [
        {
          ...
          user_name: "Caleb",
          content:
            "Great question, and it's an area that's gaining attention in the realm of AI and creativity. While the field is still relatively new, there are some interesting studies and observations that shed light on the impact of generative AI on creative thinking. Research suggests that the most effective use of AI in creative industries is as an augmentative tool rather than an entirely autonomous creator. When artists and filmmakers view AI as a collaborator, it tends to enhance and expand their creative capabilities rather than replace them. Creative professionals often adapt their thinking processes when incorporating AI. They may explore new ideas and directions prompted by AI-generated insights, leading to a more iterative and experimental approach to creativity. Studies indicate that the most successful creative endeavors often involve a harmonious combination of human and AI expertise. The synergy between the unique intuition, emotional intelligence, and lateral thinking of humans, coupled with the analytical and pattern-recognition capabilities of AI, can result in truly innovative outcomes.",
          timestamp: 1708621902537,
          highlights: [],
          whole_to_thread_id: null,
        },
      ],
    },
    {
      ...
      comments: [
        ...
        },
        {
          ...
          timestamp: 1708622081214,
          highlights: [],
          whole_to_thread_id: 10,
        },
      ],
    },
    {
    ...
    },
    {
      thread_id: 12,
      parent_thread_id: 11,
      quote: "do you think it's fair to those original creators?",
      quote_by: "Ava",
      comments: [
        {
          comment_id: 1,
        ...
        },
        {
          ...
          timestamp: 1708622924080,
          highlights: [],
          whole_to_thread_id: 14,
        },
      ],
    },
    {
      ...
      comments: [
        {
          ...
          user_name: "Caleb",
          content:
            "The issue of compensating or acknowledging the sources of training data is indeed a significant concern. It's crucial for us to be cognizant of the potential impact on the original creators whose work contributes to the development of these AI algorithms.\n\nAs we move forward, I believe it's important for us to advocate for transparency and fair practices within the AI community. Whether through collaboration with AI companies that prioritize ethical data sourcing or by contributing to the conversation around responsible AI use, we can play a role in shaping industry standards.",
          timestamp: 1708622984663,
          highlights: [],
          whole_to_thread_id: null,
        },
      ],
