  ...
  return (
    ...
    >
      <div className="flex h-fit min-h-screen w-full flex-col items-center max-md:m-0 max-md:px-6">
        <div
          className={`absolute z-[9999] mt-2 flex w-[calc(100vw-1rem)] flex-row items-center justify-between rounded-sm border border-neutral-100 bg-white/80 p-2 shadow-sm backdrop-blur-md md:mt-5 md:w-[42rem]`}
        >
          <div>
          ...
          <div className="flex flex-row">
            <div className="mr-2">
              <Link href="/demo/posts/ai-posts/example">
                <Button
                  className={`${satoshi.className} h-8 rounded-sm bg-neutral-500 p-3 text-xs text-neutral-50 shadow-none duration-100 hover:bg-neutral-500/90 md:h-10 md:p-4 md:text-sm`}
                >
                  Try demo
                </Button>
              </Link>
            ...
            <div>
              <Link href="https://tally.so/r/nGdzAO">
                <Button
                  className={`${satoshi.className} h-8 rounded-sm bg-[#FF5F1F] p-3 text-xs text-neutral-50 shadow-none duration-100 hover:bg-[#FF5F1F]/90 md:h-10 md:p-4 md:text-sm`}
                >
                  Get early access
                </Button>
              </Link>
        ...
        <div className="relative mb-56 mt-16 w-full md:mt-24 xl:w-[76rem]">
          <Image
            ...
            height="0"
            sizes="100vw"
            className="home-demo absolute z-10 h-auto w-full rounded-sm border border-neutral-200 shadow-md md:rounded-sm"
        ...
        <div className="mt-[8rem] flex flex-col items-center justify-center rounded-sm bg-[#1D1C1A] px-8 py-8 text-base font-normal leading-[1.4rem] text-neutral-400 md:mt-[40rem] md:p-56 md:text-2xl md:leading-[2.2rem]">
        ...
        <div className="mt-36 flex flex-col items-center justify-center rounded-sm bg-[#1D1C1A] px-8 py-8 text-base font-normal leading-[1.4rem] text-neutral-400 md:mt-56 md:p-56 md:text-2xl md:leading-[2.2rem]">
          <div className="w-full md:w-[48rem]">
            <p>
